...
1. **Home Screen (Главный экран)** - список всех учебных дисциплин в виде карточек
2. **Details Screen (Экран деталей)** - подробная информация о выбранной дисциплине с описанием курса
3. **Profile Screen (Профиль студента)** - информация о студенте, успеваемости и статистике
4. **Settings Screen (Настройки)** - настройки приложения с переключателями и пунктами меню
5. **Schedule Screen (Расписание)** - расписание занятий на неделю с информацией о времени, аудитории и преподавателе
6. **Schedule Detail Screen (Детали занятия)** - подробная информация о конкретном занятии из расписания
...
│
└──→ Schedule Detail Screen (schedule/{itemId})
└──→ [возврат назад]
